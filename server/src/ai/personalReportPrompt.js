...
<ul>
  ...
  <li><strong>[上線]</strong>：v2.1.0 發布，同步完成 12 組回歸測試與 API 串接文件補齊</li>
</ul>
<h2>2. 補充說明 (Why)</h2>
<div class="card">
  <ul>
...
- 若「核心重點」原文超過 3 條，**濃縮整理成最重要的 3 條 <li>**：依原文重要性由高到低，把主題相近或關聯性高的點合併成一條複合重點，讓每條盡量涵蓋到原文中屬於同一主題的關鍵資訊（例如同時提及做了什麼、涉及範圍或具體數字），而不是單純刪除次要條目或只保留單一主題。只有在合併後仍明顯次要、與其他重點重複的細節，才可以省略；**不能新增原文沒有的內容、數字或結論**，只能整理、合併、精煉原文既有的語句。
...
4. 第一頁 <h1> 用 "🚀 {成員姓名}｜{Product 名稱}"，第二頁 <h1> 用 "📋 {Product 名稱} 下週計畫與討論"。
